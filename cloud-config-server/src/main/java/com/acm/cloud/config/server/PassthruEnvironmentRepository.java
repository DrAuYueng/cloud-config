...
/**
 * Simple implementation of {@link EnvironmentRepository} that just reflects an
 * existing Spring Environment.
 * 
 * @author Dave Syer
 * @author Roy Clarkson
 */
public class PassthruEnvironmentRepository implements EnvironmentRepository {
    ...
    private Set<String> standardSources = new HashSet<String>(Arrays.asList("vcap",
            ...
            StandardEnvironment.SYSTEM_ENVIRONMENT_PROPERTY_SOURCE_NAME, StandardServletEnvironment.JNDI_PROPERTY_SOURCE_NAME,
